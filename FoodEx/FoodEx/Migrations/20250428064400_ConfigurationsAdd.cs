    ...
    public partial class ConfigurationsAdd : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", "0aa92d9e-8bb1-479e-8eff-2bab8b107e04", "Admin", "ADMIN" },
                    { "2", "971e875d-061d-4980-b444-452ed33da284", "User", "USER" },
                    { "3", "3cd1bffa-d004-4b65-a42d-c1f461cfce1e", "DeliveryGuy", "DELIVERYGUY" },
                    { "4", "6dba00c0-dcb5-4101-b03a-6a5c09c4b2df", "Restaurant", "RESTAURANT" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "admin-user-id", 0, "007026ac-6bef-4616-9bce-b73753a80e2b", "admin@foodex.com", true, false, null, "ADMIN@FOODEX.COM", "ADMIN", "AQAAAAEAACcQAAAAEL3W1FAwVsu97uoW14QiR6ir8re1Ykd5+DmcjWzhbPfnVoXSu+md75+Dqjk116A1Uw==", null, false, null, "26e6a8f5-b1ef-498a-8dbc-44cfcb40d4af", false, "admin" },
                    { "deliveryguy-user-id", 0, "995792c1-ebb4-490a-bbe9-b2ac71962185", "deliveryguy@foodex.com", true, false, null, "DELIVERYGUY@FOODEX.COM", "DELIVERYGUY", "AQAAAAEAACcQAAAAEM37kOcjUMgSkFFWzjyFb1nI4AxVOefKqv/cn4+sYOstt96It2mr3Dmsp/QQHs8LzQ==", null, false, null, "eb90e108-68ca-4f49-8d1b-c3185011bf68", false, "deliveryguy" },
                    { "regular-user-id", 0, "514f034a-7364-4179-b4bc-67b425e068fa", "user@foodex.com", true, false, null, "USER@FOODEX.COM", "USER", "AQAAAAEAACcQAAAAEEpzW3eu1h89c2LZFFfNe17t8Wrm6U40FdzX+YI6dIDbfRcqf2AsGPLPb0hXCyAIig==", null, false, null, "3123b9e6-cf14-455f-9e75-c1b629df5847", false, "user" },
                    { "restaurant-user-id", 0, "cf409d70-c2b1-4a3e-81b1-a7be8fcd9214", "restaurantowner@foodex.com", true, false, null, "RESTAURANTOWNER@FOODEX.COM", "RESTAURANTOWNER", "AQAAAAEAACcQAAAAEILtwtFvT5Ei92XjOOvnHblukRNieZ0b6tLIgkPcg46dDYVjcXc6CQiZLpAr9PtB0g==", null, false, null, "945cc551-0667-4994-b21c-6298469fefa8", false, "restaurantowner" }
                });
